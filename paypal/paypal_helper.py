...
class Paypal:
    ...
    def __init__(self):
        ...
        'USER' : 'laurentenhoor_api1.gmail.com', # Edit this to your API user name
        'PWD' : '4WLJW9NSNS5U672X', # Edit this to your API password
        'SIGNATURE' : 'AX0k7--E8124Zq8iDMqFDVJa3nx1AIeDzR8uHwsqZQ9IKNgZwrlhJspl', # edit this to your API signature
        'VERSION' : '106.0',
#         'USER' : 'laurentenhoor-facilitator_api1.gmail.com', #SANDBOX
#         'PWD' :'1403877035', #SANDBOX
#         'SIGNATURE' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31AnxMpEgWsQEZ1e7xxrMOYanv5NV8',#SANDBOX
        }
#         self.return_url = 'http://www.samsamsam.nl/payment_return/'
        self.cancel_url = 'http://www.samsamsam.nl/overview/'
        self.API_ENDPOINT = 'https://api-3t.paypal.com/nvp'
        self.PAYPAL_URL = 'https://www.paypal.com/webscr&cmd=_express-checkout&token='
#         self.API_ENDPOINT = 'https://api-3t.sandbox.paypal.com/nvp' #SANDBOX
#         self.PAYPAL_URL = 'https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token=' #SANDBOX
        self.signature = urllib.urlencode(self.signature_values) + "&"
        self.amount = 0.15

    # API METHODS
    def SetExpressCheckout(self, accesstoken,  **kwargs):
        params = {
            'METHOD' : "SetExpressCheckout",
            'NOSHIPPING' : 1,
            'RETURNURL' : 'http://www.samsamsam.nl/payment_do/',
...
#             'L_PAYMENTREQUEST_0_ITEMCATEGORY0' : 'Digital',
            'L_PAYMENTREQUEST_0_NAME0' : 'Samsamsam bevestiging',
#             L_PAYMENTREQUEST_0_QTY0=1  
            'L_PAYMENTREQUEST_0_DESC0' : 'Transactiekosten',
            'L_PAYMENTREQUEST_0_AMT0' : self.amount,
            'ALLOWNOTE' : 0,
            'BRANDNAME' : "Bevestig uw Samsamsam met de betaling van de transactiekosten.",
        }
...
#             'RETURNURL' : 'http://www.samsamsam.nl/payment_do', #edit this 
#             'CANCELURL' : self.cancel_url, #edit this 
            'TOKEN' : token,
        }
        params_string = self.signature + urllib.urlencode(params)
        response = urllib.urlopen(self.API_ENDPOINT, params_string).read()
    ...
    def DoExpressCheckoutPayment(self, token, payer_id):
        params = {
            'METHOD' : "DoExpressCheckoutPayment",
            'PAYMENTACTION' : 'Sale',
            'RETURNURL' : 'http://www.samsamsam.nl/payment_return', #edit this 
            'CANCELURL' : self.cancel_url, #edit this 
            'TOKEN' : token,
            'PAYERID' : payer_id,
            'PAYMENTREQUEST_0_AMT' : self.amount,
